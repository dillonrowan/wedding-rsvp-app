...
export default async function Page({ params, searchParams }) {
    ...
    console.log("THIS IS SEARCH PARAMS");
    console.log(searchParams);
    console.log(params);
    //const searchParamsParsed = JSON.parse(searchParams)
    const rsvpGroup = searchParams ? JSON.parse(searchParams["rsvp-group"]) : {};
            ...
            rsvps: [
                {
                    ...
                    name: "John Smith",
                    attending: true,
                    dietaryRestrictions: ["NO_RED_MEAT", "NO_CHICKEN"],
    ...
    return (
        <>
            ...
            {/* <RsvpGroupUpdateForm rsvpGroup={rsvpGroup}/> */}
        </>
    );
    ...
    //     {/* <form action={`${process.env.NEXT_PUBLIC_HOST}/rsvp/group/submitted`} name={rsvpGroup.id}>   */}
    //       <div>
